/**
 * CMS Platform — SVG Icon System
 *
 * 60+ hand-crafted SVG icons for the admin dashboard and frontend.
 * All icons are 24x24 viewBox, stroke-based, with currentColor support.
 *
 * Usage:
 *   import { IconPost, IconDashboard } from '@/components/icons';
 *   <IconPost className="w-5 h-5 text-blue-500" />
