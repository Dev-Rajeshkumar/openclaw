  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-amber-50"),
        day_selected: "bg-amber-500 text-white hover:bg-amber-600 focus:bg-amber-500 focus:text-white",
